...
Main.render = function(frames) {
	...
	g2.set_color(-65536);
	var _g = 0;
	var _g1 = Main.logo.length;
	while(_g < _g1) {
		var rowIndex = _g++;
		var row = Main.logo[rowIndex];
		var _g2 = 0;
		var _g3 = row.length;
		while(_g2 < _g3) {
			var colIndex = _g2++;
			if(row.charAt(colIndex) == "1") {
				g2.fillRect(colIndex * 16,rowIndex * 16,16,16);
			}
		}
	}
...
var Star = function(size,position) {
	...
	this.fillBuffers(32,size,position,Star.structure);
};
$hxClasses["Star"] = Star;
Star.__name__ = true;
Star.prototype = {
	fillBuffers: function(segments,size,position,structure) {
		...
		Star.vBuffer = new kha_graphics4_VertexBuffer(vertexCount,structure,0);
		Star.vertexData = Star.vBuffer.lock();
		Star.iBuffer = new kha_graphics4_IndexBuffer(indicesCount,0);
		var indexData = Star.iBuffer.lock();
		var v = position.x;
		Star.vertexData.setFloat32(0,v,true);
		var v = position.y;
		Star.vertexData.setFloat32(4,v,true);
		Star.vertexData.setFloat32(8,0.,true);
		Star.vertexData.setFloat32(12,0.,true);
		Star.vertexData.setFloat32(16,0.3,true);
		var _g = 0;
		var _g1 = segments;
		while(_g < _g1) {
			var i = _g++;
			...
			var index = (i + 1) * 5;
			Star.vertexData.setFloat32(index * 4,x,true);
			Star.vertexData.setFloat32((index + 1) * 4,y,true);
			Star.vertexData.setFloat32((index + 2) * 4,0.,true);
			Star.vertexData.setFloat32((index + 3) * 4,0.,true);
			Star.vertexData.setFloat32((index + 4) * 4,0.3,true);
			var k = i * 3;
			indexData.setUint32(k * 4,0,kha_arrays_ByteArray.LITTLE_ENDIAN);
			var tmp = k * 4;
			var k1 = i * 3 + 1;
			indexData.setUint32(k1 * 4,i + 1,kha_arrays_ByteArray.LITTLE_ENDIAN);
			var tmp1 = k1 * 4;
			var k2 = i * 3 + 2;
			indexData.setUint32(k2 * 4,i + 2 > segments ? 1 : i + 2,kha_arrays_ByteArray.LITTLE_ENDIAN);
			var tmp2 = k2 * 4;
		}
		Star.vBuffer.unlock();
		Star.iBuffer.unlock();
		Star.pipeline = new kha_graphics4_PipelineState();
		Star.pipeline.inputLayout = [structure];
		Star.pipeline.vertexShader = kha_Shaders.simple_vert;
		Star.pipeline.fragmentShader = kha_Shaders.full_galaxy_frag;
		Star.pipeline.colorAttachmentCount = 1;
		Star.pipeline.colorAttachments[0] = 0;
...
kha_Shaders.init = function() {
	var blobs = [];
	var data = Reflect.field(kha_Shaders,"full_galaxy_fragData" + 0);
	var bytes = haxe_Unserializer.run(data);
	blobs.push(kha_internal_BytesBlob.fromBytes(bytes));
	var data = Reflect.field(kha_Shaders,"full_galaxy_fragData" + 1);
	var bytes = haxe_Unserializer.run(data);
	blobs.push(kha_internal_BytesBlob.fromBytes(bytes));
	kha_Shaders.full_galaxy_frag = new kha_graphics4_FragmentShader(blobs,["full_galaxy.frag.essl","full_galaxy-webgl2.frag.essl"]);
	var blobs = [];
...
kha_Shaders.full_galaxy_fragData0 = "s6194:";
kha_Shaders.full_galaxy_fragData1 = "s6206:";
...
kha_Shaders.simple_vertData0 = "s360:";
kha_Shaders.simple_vertData1 = "s386:";

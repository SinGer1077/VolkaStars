...
class Empty {
	...
	public function new() {
        ...
        //pipeline.vertexShader = VertexShader.fromSource("simple.vert.glsl");
		//pipeline.fragmentShader = FragmentShader.fromSource("simple.frag.glsl");	
		pipeline.vertexShader = Shaders.simple_vert;
		pipeline.fragmentShader = Shaders.simple_frag;	
        trace("Vertex shader: " + pipeline.vertexShader);
		trace("Fragment shader: " + pipeline.fragmentShader);
	...
	public function render(frames:Array<Framebuffer>) {
		...
		g.clear(Color.Purple, Math.POSITIVE_INFINITY);
